...
(422, 'notifygru-ticketing.ProviderService', 1, 0, '${user_message}', 'Traité', 'Mairie de Paris', 'Réponse à votre demande ${reference}', 4, 3, 1, 'Traité', '${user_message}', 1, 'Réponse à votre demande ${reference}', '${user_message}', 'Mairie de Paris', '', '', 1, 'Bonjour ${firstname} ${lastname}, Nous avons répondu à votre demande ${reference}. Cordialement. Mairie de Paris', 1, 1, 'Mairie de Paris', 'Réponse à votre demande ${reference}', '${user_message}', '', '', 1),
