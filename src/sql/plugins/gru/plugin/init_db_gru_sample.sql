...
( 1 , 2 , 'Gérer la sollicitation' , 'jsp/admin/plugins/ticketing/ManageTickets.jsp?view=modifyTicket&id=1' ),
( 2 , 3 , 'Gérer la sollicitation' , 'jsp/admin/plugins/ticketing/ManageTickets.jsp?view=modifyTicket&id=1' ),
